...
const en = {
  ...
  'app.subtitle': 'Reduce file size while preserving quality. 100% private — processed in your browser.',
  ...
  'app.error.corrupt': 'Could not compress this PDF. It may be corrupted or use an unsupported format.',
  ...
  'results.unchangedBody': 'This PDF was already as small as we can make it — your original was kept unchanged ({mb}).',
...
const es: Translations = {
  ...
  'app.error.corrupt': 'No se pudo comprimir este PDF. Puede estar dañado o en un formato no compatible.',
  ...
  'results.unchangedBody': 'Este PDF ya era tan pequeño como podemos hacerlo — se conservó el original ({mb}).',
