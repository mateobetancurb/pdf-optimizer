...
export function CompressionSettings({ quality, onQualityChange }: CompressionSettingsProps) {
  ...
  const levels: { value: Quality; title: string; detail: string }[] = [
    {
      value: "screen",
      title: t("compressionSettings.screen.title"),
      detail: t("compressionSettings.screen.detail"),
    },
    {
      value: "ebook",
      title: t("compressionSettings.ebook.title"),
      detail: t("compressionSettings.ebook.detail"),
    },
    {
      value: "print",
      title: t("compressionSettings.print.title"),
      detail: t("compressionSettings.print.detail"),
    },
  ];
          ...
          return (
            ...
            >
              ...
              <span className="flex flex-col">
                <span
                  className={`text-label-md font-semibold ${isSelected ? "text-primary" : "text-on-surface"}`}
                >
                  {level.title}
                </span>
